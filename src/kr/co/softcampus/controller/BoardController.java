...
public class BoardController {
	...
	@GetMapping("/main")
	public String main(@RequestParam(value = "board_info_idx", defaultValue = "1") int board_info_idx,
	...
	public String read(@RequestParam("board_info_idx") int board_info_idx, 
		...
		if (board_info_idx == 2 && loginUserBean.isUserLogin() == false) {
		...
		boardService.updateContentViewcnt(content_idx);
